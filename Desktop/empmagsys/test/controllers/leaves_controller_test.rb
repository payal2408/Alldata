...
class LeavesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create leafe" do
    assert_difference('Leave.count') do
      post leaves_url, params: { leafe: { days: @leafe.days, employee_id: @leafe.employee_id, resion: @leafe.resion } }
    end
  ...
  test "should update leafe" do
    patch leafe_url(@leafe), params: { leafe: { days: @leafe.days, employee_id: @leafe.employee_id, resion: @leafe.resion } }
