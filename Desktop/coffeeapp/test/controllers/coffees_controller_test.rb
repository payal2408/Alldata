...
class CoffeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coffee" do
    assert_difference('Coffee.count') do
      post coffees_url, params: { coffee: { coffe_name: @coffee.coffe_name, price: @coffee.price } }
    end
  ...
  test "should update coffee" do
    patch coffee_url(@coffee), params: { coffee: { coffe_name: @coffee.coffe_name, price: @coffee.price } }
